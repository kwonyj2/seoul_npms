...
REGULAR_SCHEMA = {
    "fields": [
        ...
        # ── 장비 수량 (자동 — NetworkDevice에서 가져옴) ──
        {"name": "switch_count",     "label": "스위치 수량",    "type": "number", "auto": True},
        {"name": "poe_count",        "label": "PoE스위치 수량", "type": "number", "auto": True},
        {"name": "ap_count",         "label": "무선AP 수량",    "type": "number", "auto": True},
        # ── 장비 점검결과 ──
        {"name": "switch_result",    "label": "스위치 점검결과",   "type": "select", "options": ["특이사항 없음", "이상있음(기타 기록)"]},
        {"name": "poe_result",       "label": "PoE스위치 점검결과","type": "select", "options": ["특이사항 없음", "이상있음(기타 기록)"]},
        {"name": "ap_result",        "label": "무선AP 점검결과",   "type": "select", "options": ["특이사항 없음", "이상있음(기타 기록)"]},
        # ── 유선 속도 측정 (숫자만 입력, Mbps) ──
        {"name": "wired_teacher_hub_down",  "label": "교사망 집선 Down", "type": "number", "group": "유선망 속도측정"},
        {"name": "wired_teacher_hub_up",    "label": "교사망 집선 Up",   "type": "number"},
        {"name": "wired_teacher_end_down",  "label": "교사망 단말 Down", "type": "number"},
        {"name": "wired_teacher_end_up",    "label": "교사망 단말 Up",   "type": "number"},
        {"name": "wired_student_hub_down",  "label": "학생망 집선 Down", "type": "number", "group": "학생망"},
        {"name": "wired_student_hub_up",    "label": "학생망 집선 Up",   "type": "number"},
        {"name": "wired_student_end_down",  "label": "학생망 단말 Down", "type": "number"},
        {"name": "wired_student_end_up",    "label": "학생망 단말 Up",   "type": "number"},
        {"name": "wired_wireless_hub_down", "label": "무선망 집선 Down", "type": "number", "group": "무선망(유선)"},
        {"name": "wired_wireless_hub_up",   "label": "무선망 집선 Up",   "type": "number"},
        {"name": "wired_wireless_end_down", "label": "무선망 단말 Down", "type": "number"},
        {"name": "wired_wireless_end_up",   "label": "무선망 단말 Up",   "type": "number"},
        # ── 무선 속도 측정 ──
        {"name": "wifi_center_down",  "label": "교실중앙 Down",   "type": "number", "group": "무선망 속도"},
        {"name": "wifi_center_up",    "label": "교실중앙 Up",     "type": "number"},
        {"name": "wifi_edge_down",    "label": "교실외곽 Down",   "type": "number"},
        {"name": "wifi_edge_up",      "label": "교실외곽 Up",     "type": "number"},
        # ── 무선망 점검 ──
        {"name": "ap_placement_result", "label": "AP 배치 일치",    "type": "select", "options": ["일치", "불일치(기타 기록)"]},
        {"name": "signal_result",       "label": "신호세기 결과",    "type": "select", "options": ["정상", "이상있음(기타 기록)"]},
        # ── 유선망 변경 확인 ──
        {"name": "switch_change_result","label": "스위치 수량변경",  "type": "select", "options": ["변경 없음", "변경있음(기타 기록)"]},
        {"name": "poe_change_result",  "label": "PoE 수량변경",     "type": "select", "options": ["변경 없음", "변경있음(기타 기록)"]},
        # ── 정보자료 관리 ──
        {"name": "info_resource_result","label": "정보자원 현황변경","type": "select", "options": ["특이사항 없음", "변경있음(기타 기록)"], "group": "정보자료 관리"},
        {"name": "chk_resource_list",  "label": "정보자원 목록",    "type": "select", "options": ["확인", "미확인"]},
        {"name": "chk_network_diagram","label": "네트워크 구성도",  "type": "select", "options": ["확인", "미확인"]},
        {"name": "chk_ap_layout",      "label": "무선AP 배치도",    "type": "select", "options": ["확인", "미확인"]},
        {"name": "chk_rack_layout",    "label": "랙 실장도",        "type": "select", "options": ["확인", "미확인"]},
        {"name": "chk_cable_schedule", "label": "선번장",           "type": "select", "options": ["확인", "미확인"]},
        # ── 기타 ──
        {"name": "smartboard_result",  "label": "전자칠판",         "type": "select", "options": ["", "특이사항 없음", "이상있음(기타 기록)"], "group": "스마트기기/기타"},
        {"name": "devit_result",       "label": "디벗",             "type": "select", "options": ["", "특이사항 없음", "이상있음(기타 기록)"]},
        {"name": "etc_smartboard",     "label": "전자칠판 상세",    "type": "textarea"},
        {"name": "etc_devit",          "label": "디벗 상세",        "type": "textarea"},
        {"name": "etc_request",        "label": "기타 요청사항",    "type": "textarea"},
        {"name": "etc_result",         "label": "기타사항 결과",    "type": "textarea"},
        # ── 사진 (스위치 설치확인서와 동일 패턴) ──
        {"name": "photo_wired_teacher_hub",  "label": "교사망 집선 사진",  "type": "photo"},
        {"name": "photo_wired_teacher_end",  "label": "교사망 단말 사진",  "type": "photo"},
        {"name": "photo_wired_student_hub",  "label": "학생망 집선 사진",  "type": "photo"},
        {"name": "photo_wired_student_end",  "label": "학생망 단말 사진",  "type": "photo"},
        {"name": "photo_wired_wireless_hub", "label": "무선망 집선 사진",  "type": "photo"},
        {"name": "photo_channel_under",      "label": "채널 AP아래 사진",  "type": "photo"},
        {"name": "photo_channel_far",        "label": "채널 먼곳 사진",    "type": "photo"},
        {"name": "photo_wifi_center",        "label": "무선 중앙 사진",    "type": "photo"},
        {"name": "photo_wifi_edge",          "label": "무선 외곽 사진",    "type": "photo"},
        # ── 확인자 서명 (스위치 설치확인서와 동일) ──
        {"name": "signature_itl",    "label": "점검자 정보",    "type": "signature"},
        {"name": "signature_school", "label": "확인자 정보",    "type": "signature"},
    ]
}
